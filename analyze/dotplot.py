...
#DIR = "/share/desa/nfs02/shouxu/cold/runs/glue/mnli/runs/ROBERTA-GRAD/grad_dumps"
...
#s = f"{num:02d}"
num_layers = 12
layer_base="self_attn_q_proj_weight.npy"
for layer_num in range(num_layers):
    indices_by_step = {}
    LAYER = f"L{layer_num:02d}_{layer_base}"
    directory = f"jamalplots-qwen/{LAYER.replace('.npy', '')}"
