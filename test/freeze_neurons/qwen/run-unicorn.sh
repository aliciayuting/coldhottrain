...
cmd="MODEL=${MODEL} DATASET=${DATASET} MAX_LENGTH=${max_length} torchrun --standalone --nproc_per_node=${devices} /home/jah649/coldhottrain/test/freeze_neurons/qwen/main.py  \
